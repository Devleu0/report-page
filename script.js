document.addEventListener('DOMContentLoaded', () => {
    ...
    const translations = {
        ...
        ja: {
            ...
            wf2_desc: "2つのリニューアル案を提示しましたが、それぞれの長所と短所についてフィードバックを受け、長所を統合した単一ページとして開発するよう要請されました。この過程でAIを活用して2つの案の長所を組み合わせましたが、レスポンシブデザイン部分が正常に動作せず、該当コードを自ら再作成して 문제를 해결しました。",
